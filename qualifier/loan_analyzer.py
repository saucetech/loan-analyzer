...
print(f"The sum of all loans is ${total_of_all_loans}")
...
print(f"The remaining maturity is {remaining_months} months")
...
if present_value >= loan_price:
    print(f"The loan's fair value is ${present_value:.2f}. Given the required minimum return of 20%, the loan is worth at least the cost to buy it.")
else: 
    print("The loan's fair value is {present_value:.2f}. It is too expensive and not worth the price.")
